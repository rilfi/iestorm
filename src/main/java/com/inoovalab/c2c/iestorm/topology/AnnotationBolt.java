...
public class AnnotationBolt extends BaseRichBolt {
    ...
    public Map<String, Set<String>> getAnnotatedMap(Document doc, String tweets)
        ...
        try {
            ...
            System.out.println("exception in GateAgent");
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            Map<String,Set<String>> annotatedMap=getAnnotatedMap((Document)emitingMap.get("document"),emitingMap.get("tweet").toString());
