...
public class IeStormTopology implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("Tokenizer_Bolt", new Tokenizer_rich_Bolt(), 20).shuffleGrouping("Simulated_Tweet");
        builder.setBolt("Gazetteer_Bolt", new Gazetteer_rich_Bolt(), 20).shuffleGrouping("Tokenizer_Bolt");
        builder.setBolt("Annotation_Bolt", new Annotation_rich_Bolt(), 20).shuffleGrouping("Gazetteer_Bolt");
